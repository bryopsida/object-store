...
export default function ObjectApiControllerPlugin(
        ...
        querystring: {
          ...
          properties: {
            ...
            offset: {
              type: 'number',
              description:
                'The offset to start fetching objects from within the area',
            },
          },
        },
      },
  ...
  fastify.get<{
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      const params: IAreaAndObjectRequest =
        request.params as IAreaAndObjectRequest
      if (
      ...
      await reply
        ...
        .header(
          'Last-Modified',
          object.metaData.lastModified != null
      ...
      schema: {
        ...
        params: {
          ...
          id: {
            type: 'string',
            description:
              'The unique identifier of the object you wish to upload',
          },
        },
      },
    },
